...
export const actionCardVariants = cva(
  'flex items-start overflow-clip transition-all duration-200',
  {
    variants: {
      variant: {
        outline:
          'bg-white border border-secondary-100 hover:bg-primary-50 hover:border-primary-100',
        elevated:
          'bg-white border border-secondary-100 shadow-md shadow-secondary-950/10 hover:bg-primary-50 hover:border-primary-100'
      },
      size: {
        medium: 'rounded-[12px]',
        large: 'rounded-[16px]'
